class ['fluent] action name (params : Symb.constant array) (duration : float) (quality : int) (p_prec : ('fluent * Timedata.t) array) (p_nprec : ('fluent * Timedata.t) array) (p_add : ('fluent * Timedata.t) array) (p_del : ('fluent * Timedata.t) array) =
object (self)
  val mutable num = 0
